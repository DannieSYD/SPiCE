...
from ..gemnet.radial_basis import RadialBasis
...
class GraphAttentionTransformer(torch.nn.Module):
    ...
    def forward(self, z, pos, batch, **kwargs) -> torch.Tensor:
        ...
        atom_embedding, atom_attr, atom_onehot = self.atom_embed(z)
...
def graph_attention_transformer_l2(irreps_in, radius, num_basis=128, 
    ...
    model = GraphAttentionTransformer(
        ...
        mean=task_mean, std=task_std, scale=None)
    return model
